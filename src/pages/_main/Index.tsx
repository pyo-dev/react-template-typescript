	...
	return (
		<div className="pyo-panel-vertical">
			<div className="pyo-dashboard-wrap">
				<div
					className="pyo-panel icon-pos"
					onClick={() => goNav(`/design`)}
				>
					<div className="pyo-icon-box color-1 icon-pos-box">
						<div className="pyo-icon-smile color-white"></div>
					</div>
				...
				>
					<div className="pyo-icon-box color-5 icon-pos-box">
						<div className="pyo-icon-el color-white"></div>
					</div>
					<div className="pyo-panel-info">
				...
				>
					<div className="pyo-icon-box color-3 icon-pos-box">
						<div className="pyo-icon-play color-white"></div>
					</div>
					<div className="pyo-panel-info">
				...
				<div
					...
					onClick={() => goNav(`/react`)}
				>
					<div className="pyo-icon-box color-4 icon-pos-box">
						<div className="pyo-icon-star color-white"></div>
					</div>
					<div className="pyo-panel-info">
